...
button1 = Button(text="+", command=plus, fg='white', bg='blue')
button1.place(x=270, y=20, width=30, height=25)

button2 = Button(text="-", command=substraction, fg='white', bg='orange')
button2.place(x=310, y=20, width=30, height=25)

button3 = Button(text="*", command=multiple, fg='white', bg='green')
button3.place(x=350, y=20, width=30, height=25)

button4 = Button(text="/", command=division, fg='white', bg='red')
...
num_box2 = Entry()
num_box2.place(x=155, y=60, width=100, height=25)
...
button5.place(x=310, y=250, width=100, height=25)
